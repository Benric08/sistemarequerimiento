import {ADD_REQUERIMIENTO,REMOVE_REQUERIMIENTO,UPDATE_REQUERIMIENTO,
   ORDER,FILTER, GETALL_REQUERIMIENTOS, ADD_ESTADO_REQUERIMIENTO, GET_ESTADO_REQUERIMIENTO} from './action-types';
